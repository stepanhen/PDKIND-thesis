...
%	"cs" for Czech
%	"en" for English
\def\StudyLanguage{cz}

% Thesis title in English (exactly as in the official assignment)
% (Note: \xxx is a "ToDo label" which makes the unfilled visible. Remove it.)
\def\ThesisTitle{\xxx{The PD-KIND algorithm in the Golem SMT solver}}

% Author of the thesis (you)
\def\ThesisAuthor{\xxx{Štěpán Henrych}}
...
\def\Supervisor{\xxx{doc. RNDr. Jan Kofroň, Ph.D.}}
...
\def\ThesisTitleCS{\xxx{Algoritmus PD-KIND v řešiči Golem}}
